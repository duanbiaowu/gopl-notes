...
func main() {
	fmt.Println("http://localhost:8081/plot?expr=sin(-x)*pow(1.5,-r)")
	fmt.Println("http://localhost:8081/plot?expr=pow(2,sin(y))*pow(2,sin(x))/12")
	fmt.Println("http://localhost:8081/plot?expr=sin(x*y/10)/10")
